...
$records = mysqli_query($conn,"select c_number,c_title,c_client,c_partner,c_sp,c_amount,c_duration,c_manager,c_date,c_attachment from contractor"); // fetch data from database
...
?>
          <tr>
            ...
            <td data-label="Number"><a target='_blank' href='myfile/'>view</a></td>
            <td data-label="Number">Ongoing</td>
